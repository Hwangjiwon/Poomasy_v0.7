...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "pdHm1SEFUfe_MMst0X7h";
	private final static String CLIENT_SECRET = "0qW5qQs7hv";
	private final static String REDIRECT_URI = "http://localhost:8090/controller/signUp";
